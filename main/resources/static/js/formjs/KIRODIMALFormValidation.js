...
function showHideListBoxOptionsofKIRODIMALFormForFullTimeStudents(form_value)
{
	...
	if(GenderVal==""){	
			...
			}else if((YearVal=="11571*2nd"||YearVal=="11571*3rd") && (GenderVal=="11558*Male") && (CategoryVal=="11562*SC"||CategoryVal=="11571*ST") && (formVal=="11568*SC-ST-Less than 2.5 Lakh" ))
       			 {
				//alert("iddd sss>> "+SubjectVal);
				document.getElementById("11570").selectedIndex=0;
				$('#11570 option').eq(1).show(); 
			...
			}else if((YearVal=="11571*2nd"||YearVal=="11571*3rd") && (GenderVal=="11558*Male") && (CategoryVal=="11562*SC"||CategoryVal=="11571*ST") && (formVal=="11568*SC-ST-More than 2.5 Lakh" ))
       			 {
				//alert("iddd sss>> "+SubjectVal);
				document.getElementById("11570").selectedIndex=0;
				$('#11570 option').eq(1).hide(); 
