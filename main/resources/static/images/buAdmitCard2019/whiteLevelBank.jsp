					...
					<div class="col-md-7 col-sm-7">
						...
						<div class="tab-content">
						  ...
						  <div class="tab-pane" id="QCFORM" role="tabpanel">
							 <%if(bid.equals("4")){%>					
								<h4>Q Form</h4>
								<ul class="listmarg">
								<li><a href="https://qwikforms.in/QwikForms/StartUrl?bid=4&cid=2259" target="_blank">Q Form Demo</a></li>  
							 <%} else if (bid.equals("19")){%>
						...
						<%}%>	
						  ...
						  <div class="tab-pane" id="QCReports" role="tabpanel">
							...
							<ul class="listmarg">
								<%if(bid.equals("4")){%>
								<li><a href="https://qwikforms.in/QwikForms/login" target="_blank">Q Form Report</a></li>
								<li><strong>UserID</strong> - DEL878@sp<br/><strong>Password</strong> - 7De3MzZ0s </li>  
								<li><a href="https://securepay.sabpaisa.in/SabPaisa/login.jsp" target="_blank">Payment Gateway Report</a></li>
