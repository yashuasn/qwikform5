...
<div class="container">
	<div class="col-md-6">
		<div class="the-headline">
			<h1>SabPaisa <span class="accentcolor">Pricing</span></h1>
			<p>Transaction charges vary according to mode of payment and from domain to domain on SabPaisa platform.</p>
			<h3 style="font-size:16px; font-weight:bold;">Rates also depend on volume of transactions and may go higher or lower depending upon transaction volume.</h3>
		</div>
		<div class="textwidget">
			<p>
				However on Sabpaisa we offer quite competitive rates. If you are a business entity or an institution wanting to partner with us on SabPaisa platform, please write to us at <strong>abhimanyu.jha at srslive.in & sabpaisa at srslive.in</strong>.
			</p>
	...
	<div class="col-md-6">
		<img src="SabPaisa/images/pricing-bg.jpg" class="so-widget-image" alt="">
	</div>
</div>
</section>
<!-- =========================== ABOUT END =========================== -->
