<!DOCTYPE html>
<!-- saved from url=(0049)http://themepush.com/demo/bizconstruct/about.jsp -->
...
<link rel="stylesheet" href="css/css-style" type="text/css" media="all">
</head>
...
<header id="header">
	<div class="container">
		<div class="logoarea">
			<div class="col-md-4">
				<a class="navbar-brand" href="../Start.jsp?bid=ALL&cid=ALL">
			...
			<div class="collapse navbar-collapse" id="navbar">
				...
				<div class="menu-top-menu-container">
					<ul id="menu-top-menu" class="nav navbar-nav nav-list">
						<li class="current-menu-item"><a href="../Start.jsp?bid=ALL&cid=ALL">Home</a></li>
						<li><a href="products.jsp">Modules</a></li>
						<li><a href="client-f.jsp">Clients</a></li>
						<li><a href="our-teams.jsp">Team</a></li>						
						<li class="dropdown  active-tab"><a title="Pages" data-hover="dropdown" class="dropdown-toggle">SabPaisa<span class="caret"></span></a>
...
<!-- =========================== ABOUT BEGIN =========================== -->
<section class="margin-bottom50 padding-top50">
<div class="container">
	<div class="col-md-6">
		<div class="the-headline">
			<h1>About <span class="accentcolor">Us</span></h1>
			<h3 style="font-size:16px; font-weight:bold;">INDIA'S FIRST AND ONLY INTEGRATED PLATFORM FOR BOTH ONLINE AND OFFLINE PAYMENT/COLLECTIONS</h3>
		</div>
		<div class="textwidget">
			<p>
				SabPaisa (SP) is India's 1st superaggregating collection and settlement techosystem. We partner with banks and payment companies to help businesses collect money from their customers smoothly, and get realtime reconciliation and reports, whether online or offline. We are also creating India's largest chain of retail outlets for cash/cheque collection by aggregating existing players in payments/logistics/retail etc
			</p>
			<h4>PROBLEM/OPPORTUNITY</h4>
			<p>
				While payment solutions are coming up in plenty to solve the pain of consumers, two major pain points for businesses/organizations - realtime collection (upstream) and settlement (downstream) -remain unresolved, especially when payments happen both online and offline
			</p>
			<h4>SOLUTION/PRODUCT</h4>
			<p>
				SabPaisa (SP) is the first to solve this problem holistically - helping businesses collect and settle payments from end-consumers through a one-stop integrated platform where we have partnered with banks on one hand and payment companies on the other
			</p>
			<h3>The integrated platform has 2 key elements:</h3>
			<ul>
				<li>SP online applications for both collection and settlement  (like FormLink, SettlePaisa, LinkPaisa) help businesses save time, money and effort</li>
				<li>SP platform super-aggregates any and all collection/payment modes, whether online or offline, and has lakhs of transaction points. This increases payment convenience manifold for businesses' customers</li>
	...
	<div class="col-md-6">
		<img src="images/bg1.png" class="so-widget-image" alt="">
	</div>
</div>
</section>
<!-- =========================== ABOUT END =========================== -->
