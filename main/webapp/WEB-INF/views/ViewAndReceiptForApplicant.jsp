		...
		<form id="nitForm" action="payForm" method="POST" modelAttribute="sampleFormData">
			<div id="customer">
				<table id="meta-heads" width="100%">
					...
					<c:if test="${ null!=beanTransData.spTransId}">
						<tr>
							<td>Reference Number</td>
							<td><c:out value="${beanTransData.spTransId}" /></td>
						</tr>
					</c:if>
					<c:if test="${ null!=beanTransData.transId}">
						<tr>
							<td>Receipt Number</td>
							<td><c:out value="${beanTransData.transId}" /></td>
						</tr>
					</c:if>
					<c:if test="${ null!=beanTransData.feeName}">
						<tr>
							<td>Category Name</td>
					...
					<c:if test="${ null!=beanTransData.getTransPaymode()}">
					...
					<c:if test="${ null!=beanTransData.transOgAmount}">
						<tr>
							<td>Total Amount of Fees</td>
							<td>Rs.&nbsp;<c:out value="${beanTransData.transOgAmount}" /></td>
						</tr>
					</c:if>
					<c:if test="${ null!=beanTransData.transStatus}">
						<tr>
