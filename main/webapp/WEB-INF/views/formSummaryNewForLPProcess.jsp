...
<body onload="ExecuteFun();">
	...
	<%
			...
			formBean=(SampleFormBean)session.getAttribute("sampleFormBean");
	...
	<%
				...
				if(null!=session.getAttribute("sampleFormBean")){
					session.removeAttribute("sampleFormBean");
				}
