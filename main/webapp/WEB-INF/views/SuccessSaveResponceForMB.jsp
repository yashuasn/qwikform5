...
<style>
 table.e-receipt td{border-bottom:1px solid #ccc; border-right:1px solid #ccc; }
 table.e-receipt td.lft{border-left:1px solid #ccc;}
</style>
...
<div class="container">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
				...
				<tr>
					<td width="20%" align="center">
						<div class="university-logo- fl-logo">
							...
							<%}else{ %>
							<img src="images/photo.png" alt="" title="" width="80"
								height="60" />
							<%} %>
			...
			<% if(null!=collegeBean.getBankDetailsOTM().getBankImage()){ %>
		<img src="data:image/png;base64,<%=Base64.getEncoder().encodeToString(collegeBean.getBankDetailsOTM().getBankImage())%>" alt=""
			title="" ></img>
			<%}else{ %>
...
<div style="width:1024px; margin:0 auto; font-family:arial; font-size:14px; text-align:center;">
<table cellpadding="10" cellspacing="0" border="0" width="100%">
	<!-- <tr>
		<td style="text-align:center;" colspan="3"><img src="images/Sab-Paisa-small.png"></td>
	</tr> -->
	<tr>
		<td style="padding: 32px 12px; font-size: 62px; font-family:verdana; text-align: center;font-weight: bold;" colspan="3">&nbsp;</td>		
	</tr>
	<tr>
		...
		<td>
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td style="font-size:44px;">Thanks !</td>
				</tr>
				<tr>
					<td style="font-size:22px;">The mandate Form is successfully submited and the link for payment has been successfully sent on Registered Email ID & Mobile No.</td>
				</tr>
