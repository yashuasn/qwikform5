...
function submitFormUsingAjax(submitShot, currentpagectr) {
	...
	//alert('argument values are::'+argument);
			if(currentpagectr=="last"){ //
				window.location="processFormNew?"+ argument+"&bid="+bid+"&cid="+cid+"&formid="+formtemplateid+ "&forminstanceid="+forminstanceid+ "&payeeProfile="+payeeProfi;
		...
		//	alert('before making ajax call array');
			...
			xhttp.open("GET", window.location.origin+result+"/processFormNew?"+ argument+"&bid="+bid+"&cid="+cid+"&formid="+formtemplateid + "&forminstanceid="+forminstanceid+ "&payeeProfile="+payeeProfile, true);
			//xhttp.send();			
