...
<body>
	...
	try{
		CollegeBean collegeBean = (CollegeBean) request.getAttribute("collegeBean"); 
					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="box-content">
								...
								<form id="" action="UpdateClientBean"  method="POST"  enctype="multipart/form-data">
										...
										<tbody>
											<tr>
												...
												<td><input  class="form-control"
													name="colId" value="<%=idval%>" type="hidden"> <input 
											...
											<tr>
												...
												<td><input type="text" class="form-control" required="required" readonly="readonly"
														name="${operatorBean.operatorAddress}" value='<c:out
															value="${CollegeBean.loginBean.userName}" />'></td>
											...
											<tr>
												...
												<td><input type="text" class="form-control" required="required" readonly="readonly"
														name="${operatorBean.operatorAddress}" value='<%=request.getAttribute("pwdQC") %>'></td>
											...
											<tr>
												...
												<td><textarea class="form-control" required="required" readonly="readonly"
														name="${operatorBean.operatorAddress}" ><%=request.getAttribute("clientUrl") %></textarea></td>
