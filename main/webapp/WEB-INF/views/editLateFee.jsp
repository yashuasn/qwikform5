					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-star-empty"></i> Late Fee Detail
								</h2>
							...
							<div class="box-content">
								...
								<form id="" action="updateNewConfiguredLateFee" method="POST"
									modelAttribute="lateFeeBean">
									...
									<table id="mainForm1"
										...
										<tbody>
											<tr>
												...
												<td>Late Fee Type <input type="hidden"
													name="formIdLateFee" id="formIdLateFee"
													value='<c:out value="${formIdForThisLateFee}"/>'>

												</td>
												<td><div id="the-basics" class="has-success">
														<div class="controls">

															<%-- <input type="text" name="latefeeType"
																readonly="readonly"
																value='<c:out value="${lateFeeBean.latefeeType}"/>'> --%>
															...
															<input type="hidden" name="id"
																value='<c:out value="${lateFeeBean.id}"/>'>
														</div>
													</div></td>
											</tr>

											<tr>
												<td>Late Fee Start Date</td>
												<td><div id="the-basics" class="has-success">
														<div class="controls">

															<input id="fromDate" name="fromDateStr" type="date"
																placeholder="Form Start Date" required="required"
											...
											<tr>
												<td>Late Fee End Date</td>
												<td><div id="the-basics" class="has-success">
														<div class="controls">
															<input id="toDate" name="toDateStr" type="date"
												...
												<td><div id="the-basics" class="has-success">
														<div class="controls">
															...
															<input type="text" name="latefeeAmount"
																value='<c:out value="${lateFeeBean.latefeeAmount}"/>'>
