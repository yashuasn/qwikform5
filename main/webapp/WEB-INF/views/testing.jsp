			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div class="row">
					...
					<label for="exampleInputEmail1"
						class="col-sm-3 col-form-label labeling">Form Name List*</label>
					<div class="col-sm-7">

						<select id="formId" class="form-control valid">
							<option value="">--Select an option--</option>
							<c:forEach items="${formMapData}" var="formView">
								<option value='<c:out value="${formView.key}"/>'> <c:out
										value="${formView.value}" /></option>
							</c:forEach>
						</select>
					</div>
				</div>
												...
												<button type="button" onclick="uploadOffLineForm()"
														class="btn btn-info btn-sm">Upload OffLine Form (Excel Document)</button>
												</td>
