...
<body>
	...
	<span style="padding-left: 70px; color: white; font-family: cursive;">  </span>
			<div class="btn-group pull-right">
				<button class="btn btn-default dropdown-toggle"
					data-toggle="dropdown">
					<i class="glyphicon glym phicon-user"></i><span
						class="hidden-sm hidden-xs"> <%=loginBean.getUserName()%></span> <span
						class="caret"></span>
				</button>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well">
								<h2>
									<i class="glyphicon glyphicon-info-sign"></i> Operator Home
								</h2>
							...
							<div class="box-content row">
								<div class="col-lg-12 col-md-12 animated fadeIn">
									<h1>
										Welcome
										<%=collegeBean.getCollegeName()%>,&nbsp;<%=collegeBean.getState()%>
										!
									</h1>
