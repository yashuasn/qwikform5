			...
			<div class="collapse navbar-collapse" id="navbar">
				...
				<div class="menu-top-menu-container">
					<ul id="menu-top-menu" class="nav navbar-nav nav-list">
						<li class="current-menu-item active-tab"><a href="StartUrl?bid=ALL&cid=ALL">Home</a></li>
						...
						<ul role="menu" class=" sub-menu">
							<li><a href="https://www.qwikforms.in/QwikForms/" target="_blank">QwikForms</a></li>
							...
							<div class="col-sm-6">
								<select class="form-control valid" id="SelectState"
													...
													<s:iterator value="stateList">
														<option value="<c:out value="stateId" />"><c:out
				...
				<div class="col-md-6 sow-services-service">
					<div class="content">
						<div class="row">
							<div class="col-md-3">
								<div class="type">
									<span class="sow-icon-fontawesome"><img src="SabPaisa/images/prologo/SabPaisaSuper.png" alt="QwikForms" title="FormLink"></span>
								</div>
							</div>
							<div class="col-md-9">
					...
					<div class="content">
						<div class="row">
							...
							<div class="col-md-9">
								...
								<p>
									 Start collecting payments and send links for any kind of payments collections in minutes with power of QwikForms and LinkPaisa, with pre-integrated SabPaisa IPG and offered payments modes are integrated cards, net banking, e-Challan, NEFT/RTGS payment options
								</p>
