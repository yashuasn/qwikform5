...
<body class="scrollTop">
	<div class="logoparts">
		...
		</span> <span class="providerlogo">
		<img src="images/sabpaisa-logo.png" alt="" title=""></span>
		<!-- <button class="btn btn-default pull-right" onclick='window.open("Cart.jsp","Cart","hieght=1024,width=768")' 
...
<div class="col-sm-12">									
	<div class="col-sm-6 ddown">
		<label>
			<input onclick="document.getElementById(${txnId}).disabled = false; document.getElementById(${applicationNo}).disabled = true;" 
			type="radio" name="type" value="" checked="checked">Enter SpTxnId
		*</label>
		<input type="text" name="txnId" id="txnId" class="form-control" value="" maxlength="25" 
		 placeholder="Enter SptxnId" required><font size="2" color="RED">
		 Ex : 67089xxxxxxxxxxxxxxxxxxx1</font>
	</div>									
	<div class="col-sm-6 ddown">
		<label>
			<input onclick="document.getElementById(${txnId}).disabled = true; document.getElementById(${applicationNo}).disabled = false;" 
		...
		*</label>
		<input type="text" name="applicationNo" id="applicationNo" class="form-control" value="" maxlength="25" 
		 ...
		 Ex : 709071xxxxxxxxxxxxxxx</font>										
			...
			<!--  the entire Form Section will be populated here -->
