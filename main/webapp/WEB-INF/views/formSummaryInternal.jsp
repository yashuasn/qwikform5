...
<div class="container">
		<div class="logoparts">
			<span class="clientlogo">
				...
				<% if(null!=colBean.getBankDetailsOTM().getBankImage()){ %>
		<img src="data:image/png;base64,<%=Base64.getEncoder().encodeToString(colBean.getBankDetailsOTM().getBankImage())%>" alt=""
			title="" height="80" width="80"></img>
			<%}else{ %>
			<img
			src="img\No-logo.jpg" alt=""
			title="" height="40" width="80"></img>
			<%} %>
...
<%@include file="formSummaryNew.jsp" %>
