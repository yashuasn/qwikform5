...
<meta charset="utf-8">
<title>QwikForms - Client Users (Actors)</title>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="box-content row">
								...
								<button onclick='window.open("actorform","ActorForm","height=480,width=800")' class="btn btn-success btn-sm pull-right">Add User (Actor)</button>
									<table class="table table-striped table-condensed datatable">
									<thead>
									<tr>
									<th>User/Actor ID</th>
									<th>User/Actor Alias</th>
									<th>User/Actor Profile</th>
									<th></th>
									</tr>
									</thead>
									<tbody>
									...
									<tr>
									<td><c:out value="${actors.actor_id}"/> </td>
									<td><c:out value="${actors.actor_alias}"/> </td>
									<td><c:out value="${actors.profile}"/> </td>
