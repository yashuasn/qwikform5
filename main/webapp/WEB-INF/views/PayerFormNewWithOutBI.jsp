...
log.info("currentFormId: PayerFormNewWithOutBI.jsp is:"+currentFormId); 
log.info("formInstanceId: PayerFormNewWithOutBI.jsp is:"+formInstanceId);
%>
<%
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box off"
			...
			<ul class="accordion-tabs-minimal" >
				<li class="tab-header-and-content"><a href="#"
					class="tab-link is-active" id="tab-11-1-1">Basic Information</a>
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 tab-content"
						id="tab-10-1">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="visibility: hidden;  display:none;">
							...
							<div class="form-group">
								...
								<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
									<input type="text" name="Email" class="form-control"
										value='nitin@srslive.in'
										id="rc_email"  placeholder="Enter Email Id"
									...
									<div class="form-group">
										...
										<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
											<input type="text" name="Aadhaar" class="form-control"
												...
												readonly="readonly" /> <span style="float: left;"> <input
												type="checkbox" onclick="toggleAadhaarTextInput()"
												...
												style="font-size: 12px; text-align: left;">I
													...
													application "QwikCollect". I also authorise them to collect
						...
						<div id="pageRCCode"
							class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="visibility: hidden; display:inline; display:none;">
							<div class="form-group">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<div class="offset-sm-2 col-sm-12">
									...
									<button onClick="return goToFormPagess()" type="button"
					...
					<tr>
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " >
							<div class="form-group">
								...
								<%-- 
								<<<<< ------------------ 19 july 2020 change by praveen ------------------- >>>>>
									...
									<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											...
											<c:when test='${fieldType.contentEquals("Document1")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document1&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											</c:when>
											...
											<c:when test='${fieldType.contentEquals("Document2")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document2&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											...
											<c:when test='${fieldType.contentEquals("Document3")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document3&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											...
											<c:when test='${fieldType.contentEquals("Document4")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document4&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											...
											<c:when test='${fieldType.contentEquals("Document5")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document5&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											...
											<c:when test='${fieldType.contentEquals("Document6")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document6&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											...
											<c:when test='${fieldType.contentEquals("Document7")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document7&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											...
											<c:when test='${fieldType.contentEquals("Document8")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document8&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											...
											<c:when test='${fieldType.contentEquals("Document9")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document9&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
											...
											<c:when test='${fieldType.contentEquals("Document10")}'>
												<input
													...
													<c:if test='${mandFlag==1}'> required='<c:out value="${formStrList.isMandatory}" />' </c:if>></input>
												<button
													onclick='window.open("PayerFileUploadGeneral?filetype=Document10&fieldId=<c:out value='${formStrList.id}'/><c:if test='${mandFlag==1}'>&flag=<c:out value='${formStrList.isMandatory}' /></c:if><c:if test='${formInstanceIdForFile!=null}'>&formInstanceIdForFile=<c:out value='${formInstanceIdForFile}' /></c:if>","File Upload Box","width=1024,height=1024")'
													type="button" class="flt btn btn-primary up-load">Upload</button>
												<span id="<c:out value='${formStrList.id}'/>"><h5></h5></span>
