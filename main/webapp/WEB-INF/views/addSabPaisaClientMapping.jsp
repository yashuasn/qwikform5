					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="box-content">
								...
								<form action="SaveSabPaisaClientMappingDetails" method="POST" modelAttribute="clientMapping" >
									...
									<table id="mainForm1">
										...
										<tbody>
												...
												<tr>
													...
													<td>SabPaisa Client Code</td>
													<td><div id="the-basics" class="has-success">
															<input  
																name="cMCode"
															
																placeholder="SabPaisa Client Code" type="text" required="required"
																class="form-control" value='<c:out value="${cMCode}"/>'>
														</div></td>
												...
												<tr>
													...
													<td><div id="the-basics" class="has-success">
															<input required="required" 
																...
																placeholder="Payer Type" type="text"
																class="form-control" value='<c:out value="${cMProfile}"/>'>
																<input  
																name="cid"
															
																placeholder="SabPaisa Client Code" type="hidden" required="required"
																class="form-control" value='<%=request.getParameter("cid") %>'>
														</div></td>
													...
													<td><div id="the-basics" class="has-success">
														...
														<textarea required="required" 
																...
																class="form-control"><c:out value="${clientUrl}"/></textarea></div></td>
