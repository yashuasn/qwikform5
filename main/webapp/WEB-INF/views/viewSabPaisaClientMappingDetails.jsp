					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								...
								<button onclick="addClientMappingDetails(<%=id %>)"
									class="btn btn-default pull-right btn-sm">Add New
									Client Mapping</button>
				...
				<div class="row">
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-star-empty"></i> Client Mapping Details
								</h2>
									...
									<table id="mainForm1"
										...
										<tbody>
											<tr>
												...
												<td><strong>SabPaisa Url</strong></td>
												<td><strong>Action</strong></td>
											
												<%-- <td><input type="hidden" class="form-control"
													value="<s:property value="collegeBean.collegeId" />"
													name="operatorBean.operatorId"> <input type="text"
													class="form-control" required="required" readonly="readonly"
													value="<s:property value="collegeBean.collegeName" />"
													name="operatorBean.operatorName"></td>
 --%>
											</tr>
											<c:forEach items="${clientMappingCodeOfSabPaisa}" var="bean">
											<tr>
												<%-- <td>${bean.cid}</td>
											<td>${bean.bid}</td> --%>
											<td><c:out value='${fn:escapeXml(bean.CMCode)}'/></td>
											<td><c:out value='${fn:escapeXml(bean.CMProfile)}'/></td>
										
											<td>${bean.clientUrl}</td>
											<td><button type="button" onclick="editSabPaisa(<c:out value='${fn:escapeXml(bean.CMCId)}'/>)">Edit</button></td>
											</tr>
											</c:forEach>
...
<script type="text/javascript">
function addClientMappingDetails(id){
	
	window.open("addSabPaisaClientMapping?cid="+id,"Fill Client Details","width=520,height=350")
}
function editSabPaisa(id){
	window.location="editSabPaisaMappingDetails?id="+id,"Client Mapping Details",
