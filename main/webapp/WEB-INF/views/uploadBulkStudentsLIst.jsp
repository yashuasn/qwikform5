					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-star-empty"></i> Fill Bank
									Details
								</h2>
							...
							<div class="box-content">
								...
								<form id="BulkStudent" action="SaveBulkStudentRecords"
									method="POST" enctype="multipart/form-data">

									<div class="form-group">
										<label for="middle-name"
											class="control-label col-md-3 col-sm-3 col-xs-12 txtfl">File
