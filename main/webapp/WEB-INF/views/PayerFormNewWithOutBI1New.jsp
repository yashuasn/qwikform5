...
<title>QwikForms PayerFormNewWithOutBI1New</title>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 tab-content"
						...
						<c:if test='${formdetails.verificationFlag=="Y"}'>
							<c:if test='${formdetails.isAadhaarVerified=="Y"}'>
								...
								<!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="form-group">
										<label class="col-lg-2 col-md-12 col-sm-12 col-xs-12">Mobile Email Consent.
											*</label>
										<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
											<input type="checkbox" id='rc_mec' value="Y" class="form-control chbox">
										</div>
									</div>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="form-group">
										<label class="col-lg-2 col-md-12 col-sm-12 col-xs-12">Residence Consent.
											*</label>
										<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
											<input type="checkbox" id='rc_rc' value="Y" class="form-control chbox">
										</div>
									</div>
								</div>-->
