					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="box-content">
								...
								<form id="AdmitCard" action="SaveSingleStudentDetails" method="POST" modelAttribute="admitBean"
									...
									<table id="mainForm1">
										<tbody>
											...
											<input id="comId" name="id"
												type="hidden" value='<c:out value="${admitBean.id}"/>'>
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<input id="payer_type" name="name"
															...
															class="form-control"
															value='<c:out value="${admitBean.name}"/>'>
													</div></td>
											...
											<!-- <td>PCI Ref No</td> -->
												...
												<td><div id="the-basics" class="has-success">
														<input id="payer_type" name="father_name"
															...
															value='<c:out value="${admitBean.father_name}"/>'>
													</div></td>
											...
											<%--	<td><div id="the-basics" class="has-success">
														<input id="payer_type" name="roll_number"
															...
															class="form-control"
															value='<c:out value="admitBean.roll_number"/>'>
													</div></td> --%>
										<td><div id="the-basics" class="has-success">
                                                 <input id="payer_type" name="roll_number"
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
													...
													class="form-control" value='<c:out value="${admitBean.reg_number}"/>'>
													</div></td>
											</tr>
											<tr>
												...
												value='<c:out value="${admitBean.applied_course}"/>'>
												</div>
												</td>
											</tr>
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<input required="required" id="payer_type"
															...
															type="text" class="form-control"
															value='<c:out value="${admitBean.category}"/>'>
													</div></td>
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<input required="required" id="payer_type"
															...
															class="form-control"
															value='<c:out value="${admitBean.gender}"/>'>
													</div></td>
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<input required="required" id="payer_type"
															...
															type="text" class="form-control"
															value='<c:out value="${admitBean.center}"/>'>
													</div></td>
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<input required="required" id="payer_type"
															...
															class="form-control"
															value='<c:out value="${admitBean.dob}"/>'>
													</div></td>
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<input required="required" id="payer_type"
															...
															class="form-control"
															value='<c:out value="${admitBean.doe}"/>'>
													</div></td>
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<input required="required" id="payer_type"
															...
															class="form-control"
															value='<c:out value="${admitBean.toe}"/>'>
													</div></td>
