...
<body class="scrollTop">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-colors">
			<ul id="main" class="nav nav-tabs">
				<li role="presentation" class="wizard-step-indicator active" id="11"><a
					href="#1" onclick="return goToStart()">Admit Card</a></li>
		...
		<div id="wizard1" class="wizard">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box " id="a_11">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 top-main-bg"
					id="1">
					<div class="pan-heading">QwikForm</div>
						...
						<div class="col-sm-12 labeling">
							...
							<form action="getAdmitCard" method="post">
								...
								<div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
									...
									<div class="title-name">Fetch Admit Card</div>
 ...
 %>
									...
									<!-- <label for="exampleInputEmail1"
										class="col-sm-3 col-form-label labeling">Enter Roll No
										*</label>
									<div class="col-sm-6 ddown" id="">
										<input type="text" name="txnId"
											class="form-control selectpicker" value="" maxlength="25"
											required></input><font size="2" color="RED"> 
											Ex : 67089xxxxxxxxxxxxxxxxxxx1</font>
									</div> -->
									
									<div class="col-sm-12">	
									
									
										<div class="col-sm-4 ddown">
											<label>
												<input onclick="document.getElementById('rollNo').disabled = false;document.getElementById('txnId').disabled = true; document.getElementById('applicationNo').disabled = true;" 
												type="radio" name="type" value="" checked="checked">Enter Roll Number
											*</label>
											<input type="text" name="rollNo" id="rollNo" class="form-control" value="" maxlength="25" 
											 placeholder="Enter Roll no" required><font size="2" color="RED">
											 Ex : 67089xxxxxx1</font>
										</div>
									
																	
										<div class="col-sm-4 ddown">
											<label>
												<input onclick="document.getElementById('txnId').disabled = false; document.getElementById('applicationNo').disabled = true; document.getElementById('rollNo').disabled = true;" 
												type="radio" name="type" value="" >Enter SpTxnId / Reference No
											*</label>
											<input type="text" name="txnId" id="txnId" class="form-control" value="" maxlength="25" 
											 placeholder="Enter SptxnId"  disabled="disabled" required><font size="2" color="RED">
											 Ex : 67089xxxxxxxxxxxxxxxxxxx1</font>
										</div>
										...
										<div class="col-sm-4 ddown">
											<label>
												<input onclick="document.getElementById('txnId').disabled = true; document.getElementById('applicationNo').disabled = false; document.getElementById('rollNo').disabled = true;" 
												type="radio" name="type" value="">Enter Application No
											*</label>
											<input type="text" name="applicationNo" id="applicationNo" class="form-control" value="" maxlength="25" 
											 placeholder="Enter Application No" disabled="disabled" required><font size="2" color="RED">
											 Ex : 709071xxxxxxxxxxxxxxx</font>										
										</div>										<div> <p>
                                    <a href="images/buAdmitCard2019/Instruction_before_downloading_the_Admit_Card_V_2.xlsx" target="_blank"><font size="5" color="RED">Information for the Students appearing in the Written Test for admission to P.G. Course of Studies 2019-2021 under Arts Faculty, please verify with the relevant information in your admit card</font></a>  </p>
                                                </div>									</div>
