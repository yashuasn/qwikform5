									...
									<table class="table table-striped table-condensed display"
										...
										<thead>
											<tr>
												...
												<th width="10%">View</th>
												<th width="10%">SabPaisa Details</th>
										...
										<c:forEach items="${collegelst}" var="bean">
											<tr>
												<td width="10%"><%=i%></td> 
												<td width="20%"><c:out value="${bean.collegeName}"></c:out>	</td>
												<td width="10%"><c:out value="${bean.collegeCode}"></c:out></td>
												<td width="10%"><c:out value="${bean.contact}"></c:out></td>
												<td width="10%"><c:out value="${bean.emailId}"></c:out></td>
												 <!-- <td colspan="3"> -->
												 <td width="10%">
													 <button type="button"
													 ...
													 <button type="button"
															...
															class="btn btn-info btn-sm">SabPaisa Details</button> 
											</td> 
