...
<%
	...
	Logger log = Logger.getLogger("Session Terminated");
							...
							<div class="box col-md-12">
								<div class="box-inner">
									<div class="box-header well" data-original-title="">
										<h2>
											<i class="glyphicon glyphicon-star-empty"></i>QwikForms
										</h2>
									...
									<div class="box-content">
										...
										<div
											...
											Your session has been terminated, please continue with the active session or start a fresh one by !
											<a class="ajax-link" href="<spring:url value="/index"/>" ><i
			class="fa fa-building"></i><span>Click Here For Re-Login</span></a>
									...
									<!-- <button class="btn btn-default"
												style="display: none;"Reset()">Reset</button> -->
