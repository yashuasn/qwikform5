...
<body>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="box-content">
								...
								<!-- <form id="FeeForm" action="" method="POST" modelAttribute="beanPayerType"> -->
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<label class="col-sm-3 col-form-label labeling">Form
														Name List*</label>
													<div class="col-sm-7">

														<select id="formId" class="form-control valid"
															onchange='AddValue(this.value)' class="form-control">
										...
										<tr>
											<td colspan="2"><button class="btn btn-sm btn-success"
													onclick="saveFormDataAsNew()" type="submit">Save</button>

												<button class="btn btn-sm btn-warning"
													onclick="window.close()">Cancel</button>

												<!-- <button class="btn btn-sm btn-success"
													onclick="saveFormDataAsUpdate()" type="submit">Update</button> -->
	...
	<script type="text/javascript">
			...
			function uploadOffLineForm() {
				...
				var formId = val;
				if (formId != "" && idVal != "") {
					window.open("offLineFormUploadForReInsert", "Preview",
							"width=640,height=480");
				} else {
					alert("please select a form first then Upload your file for proceed.");
					return false;
				}
			}

			//saveFormDataAsNew
			function saveFormDataAsNew() {

				//alert("formId is "+val);
				var formId = val;
				if (formId != "" && idVal != "") {
					window.location = "saveFormDataAsNewTarget?formId="
							+ formId;
				} else {
