													...
													<tr>
														...
														<td> 
															<select name='selectedValue'
																	...
																	<c:forEach items="${mappedFieldList}" var="mapped" varStatus="index">
																		
																		<c:if test="${mapped.key == columnNameList }">
																			<option value="">--Select Any One--</option> 
																			<c:forEach items="${mapped.value}" var="item" varStatus="loop">
														...
														<td> 
															<select name='selectedValue'
																	...
																	<c:forEach items="${mappedValidationList}" var="valid">
																		
																		<c:if test="${valid.key == columnNameList }">
																			<option value="">--Select Any One--</option> 
																			<c:forEach items="${valid.value}" var="validItem">
															        			<option value='<c:out value="${validItem}" />'>
															        			<c:out value="${validItem}" /></option>
															    			</c:forEach>
																		</c:if>
