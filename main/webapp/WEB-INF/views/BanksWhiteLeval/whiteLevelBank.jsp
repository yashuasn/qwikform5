...
<body class="wide comments example">
	...
	<%if(bid.equals("19") || bid.equals("4") || bid.equals("11") || bid.equals("31")){%>
	<section>
			<div class="container">
				<div class="row">
					<div class="col-md-7 col-sm-7">
						...
						<div class="tab-content">
						  <div class="tab-pane active" id="QCPG" role="tabpanel">
							...
							<ul class="listmarg">
							<%if(bid.equals("4")){%>
							<li><a href="https://securetest.sabpaisa.in/SabPaisaClientTest/payLink?clientCode=LPSD1" target="_blank">Payment Gateway Demo</a></li>								
								<%--<li><a href="https://securetest.sabpaisa.in/SabPaisaClientTest/clientDetailServlet?clientCode=LPSD1&environment=PCIDS" target="_blank">Payment Gateway Demo</a></li> --%>								
                                                 <%} else if (bid.equals("11")){%>
                                                                <li><a href="https://securetest.sabpaisa.in/SabPaisaClientTest/payLink?clientCode=DIDFC" target="_blank">Payment Gateway Demo</a></li>
   	
						<%} else if (bid.equals("19")){%>
								<li><a href="https://securetest.sabpaisa.in/SabPaisaClientTest/payLink?clientCode=NITE5" target="_blank">Payment Gateway Demo</a></li>
						  ...
						  <div class="tab-pane" id="QCFORM" role="tabpanel">
							 <%if(bid.equals("4")){%>					
								<h4>Q Form</h4>
								<ul class="listmarg">
								<li><a href="https://qwikforms.in/QwikForms/StartUrl?bid=4&cid=2059" target="_blank">Q Form Demo</a></li>  


							 <%}else if(bid.equals("11")){%>
                                                                <h4>Q Form</h4>
                                                                <ul class="listmarg">
                                                                <li><a href="https://qwikforms.in/QwikForms/StartUrl?bid=11&cid=2259" target="_blank">Q Form Demo</a></li>
						...
						<%}%>	
						  ...
						  <div class="tab-pane" id="QCReports" role="tabpanel">
							...
							<ul class="listmarg">
								<%if(bid.equals("4")){%>
								<li><a href="https://qwikforms.in/QwikForms/cLogin" target="_blank">Q Form Report</a></li>
								<li><strong>UserID</strong> - DEL878@sp<br/><strong>Password</strong> - 7De3MzZ0s </li>  
								<li><a href="https://partner.sabpaisa.in/" target="_blank">Payment Gateway Report</a></li>
								<li><strong>UserID</strong> - Abh789@sp<br/><strong>Password</strong> - P8c3WQ7ei </li>
						        <% }if(bid.equals("11")){%>

                                                <%--            <li><a href="https://www.qwikcollect.in/QwikCollect/login" target="_blank">Q Form Report</a></li> --%>
                                                                <li><a href="https://qwikforms.in/QwikForms/cLogin" target="_blank">Q Form Report</a></li>
                                                                <li><strong>UserID</strong> - Jnc710@sp<br/><strong>Password</strong> - 5e3XaNg1cG </li>
                                                                <li><a href="https://partner.sabpaisa.in/" target="_blank">Payment Gateway Report</a></li>
                                                                <li><strong>UserID</strong> - Dem21@sp<br/><strong>Password</strong> - S936ynAGld</li>
						...
						<%--		<li><a href="https://www.qwikcollect.in/QwikCollect/login" target="_blank">Q Form Report</a></li> --%>
								...
								<li><strong>UserID</strong> - Jnc710@sp<br/><strong>Password</strong> - 5e3XaNg1cG </li> 
								<li><a href="https://partner.sabpaisa.in/" target="_blank">Payment Gateway Report</a></li>
								<li><strong>UserID</strong> - Ish988@sp<br/><strong>Password</strong> - wF2F0io7gdNj </li> 
							<%}%>
							</ul>
						  </div>
...
function getCollegeList(stateId) {	
    ...
    function ValidateSubmit() {
        ...
        if(cid!=2805){
        	...
        	location.href="http://services.sabpaisa.in/pages/ins.html"
        	/* window.open('http://services.sabpaisa.in/pages/ins.html', '_self'); */
        }
