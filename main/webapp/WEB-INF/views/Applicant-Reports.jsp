	...
	<div class="navbar navbar-default" role="navigation">
		...
		<div class="navbar-inner">
			<button type="button" class="navbar-toggle pull-left">
				...
				src="<%=collegeBean.getCollegeLogo()%>"></a>
			<a class="navbar-brand" href="<%=clientLogoLink%>"><span>
					<%=collegeBean.getCollegeName()%>,<br><%=collegeBean.getState()%>
			</span></a>
	...
	<div class="ch-container">
							...
							<div class="box-inner">
								...
								<div class="box-content">
									...
									<table class="table table-striped table-condensed datatable"
										...
										<thead>
											<tr>
												<td><a href="ApplicantReports?ForDownLoad=True">
										...
										<c:forEach items="${noidaFormBeansList}" var="nfBeansList">
											<tr>
												<td><c:out value="${nfBeansList.financialYear}" /></td>
												<td><c:out value="${nfBeansList.department}" /></td>
												<td><c:out value="${nfBeansList.bidderID}" /></td>
												<td><c:out value="${nfBeansList.TenderReferenceNo}" /></td>
												<td><c:out value="${nfBeansList.paymentType}" /></td>
												<td><c:out value="${nfBeansList.tenderType}" /></td>
												<td><c:out value="${nfBeansList.firstName}" /></td>
												<td><c:out value="${nfBeansList.mobileNumber}" /></td>
												<td><c:out value="${nfBeansList.nameofTheBank}" /></td>
												<td><c:out value="${nfBeansList.bankBranch}" /></td>
												<td><c:out value="${nfBeansList.bankaccountNo}" /></td>
												<td><c:out value="${nfBeansList.amount}" /></td>
												<td><c:out value="${nfBeansList.merchantTransactionID}" /></td>
											</tr>
										</c:forEach>
		...
		<script>
			...
			function TotalFee(y) {
				...
				document.getElementById("total").value = fee + busfee
						+ hostelfee;
			}
			function Pay() {
