...
<meta charset="utf-8">
<title>QwikForms Add New User(Actor)</title>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-star-empty"></i> Add New Actor
								</h2>
							...
							<div class="box-content">
								...
								<form id="ActorForm" action="saveActor" method="POST" modelAttribute="actor">
									

									<table class="table table-condensed table-striped" id="mainForm1">
										<tbody>
												...
												<tr>
													...
													<td><div id="the-basics" class="has-success">
															<input required="required"
																...
																placeholder="Actor Name" type="text"
																class="form-control">
														</div></td>
</tr><tr>
													<td>Actor Profile</td>
													<td><select onchange="getMoreOptions(this.value)" style="width:50%" data-rel="chosen" 
															name="profile">
												...
												<tr id="revOptions">
												<td>Email Address</td>
												<td><input id="revEmail" class="form-control" type="email" name="email" required="required"></td>
												</tr>
