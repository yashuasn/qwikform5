									...
									<div class="col-lg-12 col-md-12 animated fadeIn">
										...
										<p class="btn-group">
											<button class="btn btn-default"
												...
												onclick="GetFormsForOffLine()">Upload OffLine Form
										...
										<p hidden>
											<button class="btn btn-default" title="Get Applicant Report"
												onclick="GetFormsForFeeConfig()">Configure Late Fee
															(Periodic with Date)</button>
										</p>
...
<!--										<p class="btn-group">
	...
	function GetFormsForOffLine() {
		idVal = "uploaded";
		//alert("file uploaded");
		//alert("formId is "+val);
			window.location = "formDataAsCollegeCode?idVal=" + idVal;	
	}
	
	function GetFormsForFeeConfig(){
		idVal = "lateFeeChange";
		//alert("file uploaded");
		//alert("formId is "+val);
			window.location = "formDataAsCollegeCode?idVal=" + idVal;
