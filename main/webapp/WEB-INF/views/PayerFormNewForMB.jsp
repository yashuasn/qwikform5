...
button.btn.btn-primary.pull-right.btn-block {
  ...
  <%
	...
	Logger log = LogManager.getLogger("Payer Form New For MB");
	...
	try {
		...
		System.out.println("FormId: PayerFormNewForMB.jsp is:" + formId);
		...
		System.out.println("payeeProfile: PayerFormNewForMB.jsp is:" + payeeProfile);
		System.out.println("msg: PayerFormNewForMB.jsp is:" + msg);
		System.out.println("cidForMaxFilledSeat1: PayerFormNewForMB.jsp is:" + cidForMaxFilledSeat1);
	...
	//alert(JSON.stringify(values)); 
			...
			<div class="container">
					<div class="row">
						...
						<div class="col-md-4 the-green-bg1">
						...
						<div class="col-md-6">
									...
									<% } else{ %>
										<h2>Please enter details in correct format</h2>
									<% } %>  --%>
    ...
    function ValidateSubmit(id) {
        ...
        if(retValue=="true"){
        	/* if(cid==cidForMaxFilledSeat){
        		...
        		window.open("requestForClientDetailsForMB?"+argument);
        	/* } */
