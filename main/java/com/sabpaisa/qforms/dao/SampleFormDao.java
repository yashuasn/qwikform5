...
public interface SampleFormDao {
	...
	public List<Map<String, Object>> colNameColValue(ArrayList<String> nameOfFields,Integer formTempId,String clientCode,
			String payerName,HttpSession ses);
